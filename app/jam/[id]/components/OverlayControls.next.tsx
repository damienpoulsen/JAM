...
function TempoControl({
    ...
    const effectiveBpm = baseBpm === null ? null : Number((baseBpm * playbackRate).toFixed(1));
    const displayValue =
        displayMode === "percent"
            ? `${percentValue}%`
            : effectiveBpm !== null
    ...
    return (
        <div className="rounded-lg border-2 border-white bg-black px-4 py-3 shadow-[0_0_0_2px_rgba(255,255,255,0.2),0_0_14px_rgba(255,255,255,0.14)]">
            <div className="flex min-h-[112px] items-stretch justify-between gap-4">
                ...
                <div className="flex flex-1 flex-col justify-between">
                    <div className="flex justify-end">
                        <div className="min-w-[138px] text-right">
                            ...
                            <div className="mt-2 rounded-md border-2 border-white bg-[#0d0d0d] px-3 py-3 text-base font-semibold text-white shadow-[0_0_0_1px_rgba(255,255,255,0.16)]">
                                {displayValue}
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex justify-end gap-2">
                        <button
                            type="button"
                            onClick={onDecrease}
                            className="flex h-8 w-8 items-center justify-center rounded-full border-2 border-white bg-black text-lg text-white shadow-[0_0_0_1px_rgba(255,255,255,0.16)] transition hover:bg-white hover:text-black"
                        >
                            -
                        </button>
...
export default function OverlayControls({
    ...
    return (
        <div className="mt-[-2px] mb-2 flex w-full justify-center">
            <div className="flex w-full max-w-[1100px] items-center justify-between gap-4 rounded-xl bg-[#3a3a40] px-6 py-2">
